...
class module():
    ...
    def procure(executed: str = "native", *args, **kwargs):
        return _module_types.get(executed, module)(*args, **kwargs)

class native_module(module):
    def __init__(self, *args, **kwargs) -> None:
        super(native_module, self).__init__(*args, **kwargs)

    def fetch(self) -> Any:
        return self.func(*self.args)

class concurrent_module(module):
    def __init__(self, frequencies: Union[int, Iterable[int]], return_type, *args, **kwargs) -> None:
        raise NotImplementedError
        super(concurrent_module, self).__init__(*args, **kwargs)
...
class thread_module(concurrent_module):
    def __init__(self, *args, **kwargs) -> None:
        super(thread_module, self).__init__(*args, **kwargs)

class process_module(concurrent_module):
    def __init__(self, *args, **kwargs) -> None:
        super(process_module, self).__init__(*args, **kwargs)

_module_types: Mapping[str, module] = {
